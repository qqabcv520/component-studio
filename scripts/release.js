...
const preId =
  args.preid || (prereleaseVersion && prereleaseVersion[0]) || 'alpha';
...
const corePkgName = 'component-stdio';
const pkgName = '@component-stdio';
  ...
  Object.keys(deps).forEach((dep) => {
    if (
      ...
      (dep.startsWith(pkgName) &&
        packages.includes(dep.replace(RegExp(`^${pkgName}\/`), '')))
    ) {
      console.log(
